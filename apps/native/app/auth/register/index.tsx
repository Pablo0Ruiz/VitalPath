...
import { FormData, schema } from '@/features/register/schema/schemaRegister';
          ...
          <ScrollView keyboardShouldPersistTaps="handled">
            <View className="flex-1 px-6">
              <View className="flex-1 justify-center items-center">
                ...
                <BodyText text="Create Account" variant="title" />

                <BodyText
                  text="Join VitalPathAI and take control of your health journey."
                  variant="subtitle"
                />
              </View>
