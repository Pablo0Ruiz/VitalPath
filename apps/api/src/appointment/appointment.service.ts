...
const ALLOWED_TRANSITIONS = CITA_ALLOWED_TRANSITIONS as Partial<
  Record<CitaState, CitaState>
>;
...
export class AppointmentService {
  ...
  async createAppointment(
    ...
    void this.notificationService.notifyAgendada(appointment);
  ...
  async updateEstadoWorker(citaId: string, estado: CitaState) {
    ...
    void this.notificationService.notifyStateChange(
      saved._id,
      saved.paciente_ID,
      estado,
    );
