    ...
    >
      ...
      {time && (
        <View className="flex-row items-center mb-2 gap-1">
          <TextField variant="caption" className="text-slate-500">
            🕐 {time}
          </TextField>
        </View>
      )}
      ...
      {doctorName && (
        <View className="flex-row items-center gap-2 mt-1">
          ...
          <TextField variant="caption" className="text-slate-600 font-medium">
            {doctorName}
          </TextField>
        </View>
      )}
      ...
      {samples && (
        <View className="bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 mt-2">
          <TextField variant="caption" className="text-slate-600">
            Muestras procesadas:{' '}
      ...
      {progressLabel !== undefined && progressValue !== undefined && (
        <View className="mt-3">
          ...
          <TextField variant="label" className="text-blue-600">
            {progressLabel}{' '}
      ...
      {pendingNote && (
        <TextField variant="caption" className="text-slate-400 mt-1">
          {pendingNote}
        </TextField>
      )}
      {estimatedTime && (
        <View className="flex-row items-center gap-1 mt-1">
          <TextField variant="caption" className="text-slate-400 italic">
